...
const siteConfig = {
  ...
  url: 'https://scala-cash.github.io',
  baseUrl: '/warhorse/',

  projectName: 'warhorse',
  organizationName: 'scala-cash',
  ...
  */
  ...
  copyright: `Copyright © ${new Date().getFullYear()} warhorse maintainers`,
  ...
  customDocsPath: 'warhorse-docs/target/mdoc',
